"""Validate size, transparency, safe margins and raw derivatives of Cosmic dice."""
...
def main() -> None:
    ...
    png_root = root / "public" / "dice" / "source" / "cosmic-compact"
    raw_root = root / "public" / "dice" / "raw" / "cosmic"
    validated = 0
    for die, count in EXPECTED.items():
        for value in range(1, count + 1):
            ...
            validated += 1
    print(f"Validadas {validated} faces Cósmicas com margem mínima de {MINIMUM_MARGIN}px.")
